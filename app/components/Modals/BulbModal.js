...
const BulbModal = ({ isVisible, greetings, message, buttonText, onClose, navigation }) => {
  return (
    <Modal visible={isVisible} transparent={true} animationType="fade">
      <Backdrop>
        <ModalBody
          ...
          start={{ x: 0.7, y: 0 }}>
          <CancelContainer onPress={onClose}>
            <ExitModalButton>
              <ModalXIcon
          ...
          <BulbColorPickerContainer>
            ...
            <ScreenTitle style={{ textAlign: 'center' }}>{`${message}`}
            ...
            <ButtonContainer>
              <SetChangeButton onPress={onClose}>
